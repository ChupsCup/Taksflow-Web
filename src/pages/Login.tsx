    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-dark-bg px-4">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-dark-border/60 bg-dark-card/85 px-6 py-3 text-sm font-medium text-white shadow-xl backdrop-blur-2xl transition-all hover:bg-dark-hover hover:border-primary/30"
        >
